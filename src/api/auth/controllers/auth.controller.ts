...
export const googleSignInController = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const signUpAdminController = async (req: Request, res: Response, next: NextFunction) => {
  try {
